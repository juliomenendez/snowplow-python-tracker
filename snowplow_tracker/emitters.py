...
class CeleryEmitter(Emitter):
    ...
    @shared_task(bind=True, name='tasks.flush')  # the self passed with bind can be used for on_fail/retrying
    ...
    def flush(self):
        ...
        """
        self.flush_emitter.delay(self)  # passes emitter (self - CeleryEmitter) to task
